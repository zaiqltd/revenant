...
Jump to: [navigation](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#column-one), [search](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#searchInput)
...
\[ [hide](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#)\]

- [1Overview](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Overview)
- [2Registers](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Registers)
- [3Channels](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Channels)
- [4Timer](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Timer)
- [5Frame Sequencer](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Frame_Sequencer)
- [6Length Counter](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Length_Counter)
- [7Volume Envelope](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Volume_Envelope)
- [8Square Wave](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Square_Wave)
- [9Frequency Sweep](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Frequency_Sweep)
- [10Noise Channel](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Noise_Channel)
- [11Wave Channel](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Wave_Channel)
- [12Trigger Event](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Trigger_Event)
- [13Channel DAC](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Channel_DAC)
- [14Mixer](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Mixer)
- [15Power Control](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Power_Control)
- [16Register Reading](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Register_Reading)
- [17Vin Mixing](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Vin_Mixing)
- [18Obscure Behavior](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Obscure_Behavior)
- [19Differences](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Differences)
- [20To Do](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#To_Do)
- [21Thanks](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware#Thanks)
...
Retrieved from " [https://gbdev.gg8.se/wiki/index.php?title=Gameboy\_sound\_hardware&oldid=998](https://gbdev.gg8.se/wiki/index.php?title=Gameboy_sound_hardware&oldid=998)"

## Navigation menu

### Views

- [Page](https://gbdev.gg8.se/wiki/articles/Gameboy_sound_hardware "View the content page [alt-shift-c]")
- [Discussion](https://gbdev.gg8.se/wiki/index.php?title=Talk:Gameboy_sound_hardware&action=edit&redlink=1 "Discussion about the content page [alt-shift-t]")
- [View source](https://gbdev.gg8.se/wiki/index.php?title=Gameboy_sound_hardware&action=edit "This page is protected. You can view its source [alt-shift-e]")
- [History](https://gbdev.gg8.se/wiki/index.php?title=Gameboy_sound_hardware&action=history "Past revisions of this page [alt-shift-h]")

### Personal tools

- [Log in](https://gbdev.gg8.se/wiki/index.php?title=Special:UserLogin&returnto=Gameboy+sound+hardware "You are encouraged to log in; however, it is not mandatory [alt-shift-o]")

[Visit the main page](https://gbdev.gg8.se/wiki/articles/Main_Page "Visit the main page")

### site navigation

- [GB dev forum](https://gbdev.gg8.se/forums/)
- [GB dev file hub](https://gbdev.gg8.se/files/)
- [Front page](https://gbdev.gg8.se/)

### wiki navigation

- [Main page](https://gbdev.gg8.se/wiki/articles/Main_Page "Visit the main page [alt-shift-z]")
- [Recent changes](https://gbdev.gg8.se/wiki/articles/Special:RecentChanges "A list of recent changes in the wiki [alt-shift-r]")
- [Random page](https://gbdev.gg8.se/wiki/articles/Special:Random "Load a random page [alt-shift-x]")
...
- [What links here](https://gbdev.gg8.se/wiki/articles/Special:WhatLinksHere/Gameboy_sound_hardware "A list of all wiki pages that link here [alt-shift-j]")
- [Related changes](https://gbdev.gg8.se/wiki/articles/Special:RecentChangesLinked/Gameboy_sound_hardware "Recent changes in pages linked from this page [alt-shift-k]")
- [Special pages](https://gbdev.gg8.se/wiki/articles/Special:SpecialPages "A list of all special pages [alt-shift-q]")
- [Printable version](https://gbdev.gg8.se/wiki/index.php?title=Gameboy_sound_hardware&printable=yes "Printable version of this page [alt-shift-p]")
- [Permanent link](https://gbdev.gg8.se/wiki/index.php?title=Gameboy_sound_hardware&oldid=998 "Permanent link to this revision of the page")
- [Page information](https://gbdev.gg8.se/wiki/index.php?title=Gameboy_sound_hardware&action=info "More information about this page")