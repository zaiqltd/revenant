...
[Print this book](https://gbdev.io/pandocs/print.html "Print this book")[Git repository](https://github.com/gbdev/pandocs "Git repository")[Suggest an edit](https://github.com/gbdev/pandocs/edit/master/src/pixel_fifo.md "Suggest an edit")

FIFO stands for _First In, First Out_. The first pixel to be pushed to the
...
- Background Priority: holds the value of the [OBJ-to-BG Priority](https://gbdev.io/pandocs/OAM.html#object-attribute-memory-oam) bit
...
VRAM. However, if the PPU’s access to VRAM is [blocked](https://gbdev.io/pandocs/pixel_fifo.html#vram-access)
...
[blocked](https://gbdev.io/pandocs/pixel_fifo.html#vram-access) then the tile data is read as $FF.
...
met then object fetching is [canceled](https://gbdev.io/pandocs/pixel_fifo.html#object-fetch-canceling).

At this point the [fetcher](https://gbdev.io/pandocs/pixel_fifo.html#fifo-pixel-fetcher) is advanced one step
...
be [canceled](https://gbdev.io/pandocs/pixel_fifo.html#object-fetch-canceling) after the fetcher has advanced a
step.
...
At this point [VRAM Access](https://gbdev.io/pandocs/pixel_fifo.html#vram-access) is checked for the lower and
...
the OAM FIFO _is_ white, or if the pixel in the OAM FIFO has higher
priority than the target object’s pixel, then the pixel in the OAM FIFO
is replaced with the target object’s properties.

Now it’s time to [render a pixel](https://gbdev.io/pandocs/pixel_fifo.html#pixel-rendering)! The same process
...
register and pushed to the LCD. On CGB when [palette access](https://gbdev.io/pandocs/pixel_fifo.html#cgb-palette-access)
...
the PPU to process. When OAM fetching is canceled, a pixel is [rendered](https://gbdev.io/pandocs/pixel_fifo.html#pixel-rendering), and
the [fetcher](https://gbdev.io/pandocs/pixel_fifo.html#fifo-pixel-fetcher) is advanced one step. This advancement
