...
[Print this book](https://gbdev.io/pandocs/print.html "Print this book")[Git repository](https://github.com/gbdev/pandocs "Git repository")[Suggest an edit](https://github.com/gbdev/pandocs/edit/master/src/Serial_Data_Transfer_(Link_Cable).md "Suggest an edit")
...
- **Transfer enable** ( _Read/Write_): If `1`, a transfer is either requested or in progress.
- **Clock speed** \[ _CGB Mode only_\] ( _Read/Write_): If set to `1`, enable high speed serial clock (~256 kHz in normal-speed mode)
- **Clock select** ( _Read/Write_): `0` = External clock (“slave”), `1` = Internal clock (“master”).
...
that the transfer is complete in two ways: SC’s Bit 7 will be cleared, and a [Serial interrupt](https://gbdev.io/pandocs/Interrupt_Sources.html#int-58--serial-interrupt)
...
Game Boy will have a [serial interrupt](https://gbdev.io/pandocs/Interrupt_Sources.html#int-58--serial-interrupt) requested at the end of the
